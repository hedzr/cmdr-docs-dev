...
date: 2021-09-30T05:00:00+08:00
last_modified_at: 2021-09-30T20:00:00+08:00
author: hedzr
tags:
  [
    c++,
...
toc: true
header:
  teaser: /images/blog/image-20210930084318643.png
...
上一篇 [谈 C++17 里的 State 模式之一](./cxx17-state-pattern/) 对于状态模式所牵扯到的基本概念做了一个综述性的梳理。所以是时候从这些概念中抽取我们感兴趣的部分予以实作了。
