...
last_modified_at: 2020-09-07T00:29:11+08:00
author: hedzr
...
With Go 1.5 (Q3 2015), `GOARCH` will become _much_ more complete.
...
> ## `go/build`: reserve `GOARCH` values for _all_ common architectures
>
...
5）如果一个文件名（不含后缀），以 _\_GOOS, _\_GOARCH, 或 \*\_GOOS_GOARCH结尾，它们隐式包含了 构建约束
