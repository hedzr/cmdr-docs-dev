...
date: 2021-08-22T14:50:00+08:00
last_modified_at: 2021-08-28T05:01:00+08:00
author: hedzr
tags:
  [
    c++,
...
toc: true
header:
  teaser: /images/blog/2021-08-21-cxx17-factory-pattern/factory-method-en.png
...
![Factory Method pattern](/images/blog/2021-08-21-cxx17-factory-pattern/factory-method-en.png)
...
![生成不同风格的系列家具。](/images/blog/2021-08-21-cxx17-factory-pattern/problem-zh.png)
...
这个类的原始动机来自于 [C++ Template to implement the Factory Pattern - Code Review Stack Exchange](https://codereview.stackexchange.com/questions/240157/c-template-to-implement-the-factory-pattern) ，但消除了原有的移植性问题，改善了构造函数的变参问题，所以现在是一个真实可用的版本，在 cmdr-cxx 中它也**_将_**是开箱即用的（`cmdr::util::factory<...>`）。
...
想要进一步了解完美转发等等知识，可以看看 [C++ 中的原位构造函数及完美转发 - 写我们自己的 variant 包装类](./in-place-construction-in-cxx/) 和 [C++ 中的原位构造函数 (2)](./in-place-construction-in-cxx-2/) ，但也应该去看 cppreferences 信息。
