...
请参考下一节：<DynamicLink href="/[lang]/docs/cmdr.v2/concepts/g72-help-system">Help Subsystem</DynamicLink>

{/*[Help Subsystem](../g72-help-system/)*/}
...
![image-20251026212658280](/images/cmdr/v2/concepts/g72-builtin-commands/image-20251026212658280.png)

类似的，一个正在自动完成中的多级子命令如下图所示：

![image-20251026213546689](/images/cmdr/v2/concepts/g72-builtin-commands/image-20251026213546689.png)
