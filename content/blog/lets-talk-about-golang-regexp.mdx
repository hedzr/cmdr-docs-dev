...
date: 2021-12-03T06:00:11+08:00
last_modified_at: 2021-12-03T07:29:11+08:00
author: hedzr
tags: [golang, regexp]
...
toc: true
header:
  teaser: /images/blog/2021-12-03-go-regexp-syntax/reFind.png
...
注意，这个示例源于 [playground](https://play.golang.org/p/kldUzzH8ZO)，但源码中的命名有一个问题：PCRE 是 _Perl Compatible Regular Expressions_ 的意思，在一个很大的程度上它几乎也是 POSIX Regular Expressions 的代名词。
...
![reFind](/images/blog/2021-12-03-go-regexp-syntax/reFind.png)
