...
This command can walk the command tree and build the responsed manpages.
...
- [Linux 命令 man 全知全会](https://hedzr.com/devops/linux/linux-man-command/) (in Chinese Only)
...
In theory, the autocompletion feature for your app will be enabled as well. But the well-tests is needed for those shells such as fish-shell, powershell and so on.
