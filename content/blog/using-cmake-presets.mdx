...
date: 2024-01-05T03:00:00+08:00
last_modified_at: 2024-01-05T05:50:00+08:00
author: hedzr
...
![image-20240104174106037](/images/blog/2024-01-05-using-cmake-presets/image-20240104174106037.png)

和

![image-20240104174132645](/images/blog/2024-01-05-using-cmake-presets/image-20240104174132645.png)
...
![Screenshot 2024-01-04 at 12.37.45](/images/blog/2024-01-05-using-cmake-presets/Screenshot%202024-01-04%20at%2012.37.45.png)

时，弹出的列表会是这样：

![Screenshot 2024-01-04 at 12.40.01](/images/blog/2024-01-05-using-cmake-presets/Screenshot%202024-01-04%20at%2012.40.01.png)
...
```json
{
  ...
  "configurePresets": [
...

    {
      "name": "use-clang",
      "hidden": true,
      "inherits": ["default-build-dir", "use-ninja"],
      "cacheVariables": {
        "CMAKE_C_COMPILER": "clang",
        "CMAKE_CXX_COMPILER": "clang++",
        "CMAKE_CXX_FLAGS": "-stdlib=libc++",
    ...
    },
    {
      "name": "linux-clang-debug",
      "displayName": "Linux clang debug",
      "inherits": ["use-clang", "debug-build"]
    },
    {
      "name": "linux-clang-release",
      "displayName": "Linux clang release",
      "inherits": ["use-clang", "release-build"]
    },
    {
      "name": "linux-gcc-debug",
      "displayName": "Linux gcc debug",
      "inherits": ["use-gcc", "debug-build"]
    },
    {
      "name": "linux-gcc-release",
      "displayName": "Linux gcc release",
      "inherits": ["use-gcc", "release-build"]
    },
    {
    ...
    },
    {
      ...
      "hidden": true,
      "inherits": ["use-msvc-cl", "windows-arch-x64"],
      "vendor": {
    ...
    },
    {
      "name": "windows-debug",
      "displayName": "Windows x64 Debug",
      "inherits": ["windows-default", "debug-build"]
    },
    {
      "name": "windows-release",
      "displayName": "Windows x64 Release",
      "inherits": ["windows-default", "release-build"]
    },
    {
      "name": "ci-options",
      "hidden": true,
    ...
    },
    {
      ...
      "inherits": ["windows-release", "ci-options"],
      "cacheVariables": {
    ...
    },
    {
      "name": "linux-ci",
      "description": "used by the ci pipeline",
      "inherits": ["release-with-debug-build", "use-gcc", "ci-options"],
      "cacheVariables": {
    ...
    },
    {
      ...
      "inherits": ["release-build", "linux-gcc-release"],
      "cacheVariables": {
        "BUILD_TESTING": "OFF",
        "BUILD_DEMO_VIEWER": "OFF",
