...
date: 2022-09-29T05:25:00+08:00
last_modified_at: 2022-09-29T15:10:00+08:00
author: hedzr
tags: [tech, disk]
...
toc: true
header:
  teaser: /images/blog/2022-09-29-hdiutil-and-sparsebundle/partition-1.png
  teaser1: /blog/2022-09-29-hdiutil-and-sparsebundle/unsplash-gallery-image-1-th.jpg
  overlay_image: /images/unsplash-gallery-image-1-th.jpg
  overlay_filter: rgba(16, 16, 32, 0.73)
excerpt: >-
  hdiutil, sparsebundle 以及操作 ...
---
...
![Open Disk Utility](/images/blog/2022-09-29-hdiutil-and-sparsebundle/partition-1.png)

首先点击 Partition 按钮，得到如下对话框：

![Partition](/images/blog/2022-09-29-hdiutil-and-sparsebundle/partition-2.png)

在分区的饼图下方点击加号按钮，给出一个分区名字 `Projects`，选择敏感分区，日志式，然后指定尺寸为 20GB：

![Settings](/images/blog/2022-09-29-hdiutil-and-sparsebundle/partition-3.png)
...
![Done](/images/blog/2022-09-29-hdiutil-and-sparsebundle/partition-5.png)

它将被自动装载到 `/Volumes/Projects` 之下。

![Proof](/images/blog/2022-09-29-hdiutil-and-sparsebundle/partition-7.png)
