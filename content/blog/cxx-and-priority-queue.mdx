...
layout: single
title: "优先队列 (C++)"
date: 2021-2-28T08:41:00+08:00
last_modified_at: 2021-2-28T09:21:12+08:00
author: hedzr
...
本文中接上一篇 [队列（C++）](./cxx-and-queue/) 回顾了队列这种数据结构后，进一步探讨优先队列（Piority Queue）的一种 C++ 实现，但限于理论性的而非工程性的，特别是，并非高频交易的。
