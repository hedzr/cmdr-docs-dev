...
layout: single
title: "C++ 命名空间"
date: 2023-7-17T05:00:00+08:00
last_modified_at: 2023-7-17T07:21:12+08:00
author: hedzr
tags: [c++, namespace]
...
| `namespace` _命名空间名_ `{` _声明序列_ `}`                    | (1) |            |
| -------------------------------------------------------------- | --- | ---------- |
| `inline` `namespace` _命名空间名_ `{` _声明序列_ `}`           | (2) | (C++11 起) |
| `namespace` `{` _声明序列_ `}`                                 | (3) |            |
| _命名空间名_ `::` _成员名_                                     | (4) |            |
| `using` `namespace` _命名空间名_ `;`                           | (5) |            |
| `using` _命名空间名_ `::` _成员名_ `;`                         | (6) |            |
| `namespace` _名字_ `=` _有限定命名空间_ `;`                    | (7) |            |
| `namespace` _命名空间名_ `::` _成员名_ `{` _声明序列_ `}`      | (8) | (C++17 起) |
| `namespace` _命名空间名_`::inline` _成员名_ `{` _声明序列_ `}` | (9) | (C++20 起) |
