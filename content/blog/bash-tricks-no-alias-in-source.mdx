...
date: 2018-10-10T09:00:00+08:00
author: hedzr
...
toc: true
header:
  overlay_image: /images/bash-shell.png
...
前缀 `\` 的目的是避免alias替换，使用命令的原生目标来执行。当 alias ls=’ls –color’ 时，ls 的输出结果是带高亮色的，`\ls` 则避免了alias替换，输出结果没有高亮色。
