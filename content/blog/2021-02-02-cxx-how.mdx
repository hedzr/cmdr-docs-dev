...
date: 2021-2-2T07:00:00+08:00
last_modified_at: 2021-2-27T05:21:12+08:00
author: hedzr
tags:
  [
    c++,
...
![image-20210218195833399](/images/blog/cxx-how/4JrRwygW3FEoj5p.png)
...
![image-20210218200735115](/images/blog/cxx-how/xXbeM2qcH3vuyAj.png)
...
- https://stackoverflow.com/questions/12227640/simplifying-complex-c-template-symbols
  ...
  [STLFilt](http://www.bdsoft.com/tools/stlfilt.html) could help you. There are two perl scripts, STLFilt.pl (for Visual C++) and gSTLFilt.p (for gcc). It's designed to be used for error messages simplification, but I've already used it for postprocessing \_\_cxa_demangle's output.
